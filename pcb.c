...
PCB create_pcb(FILE *script, char *filename)
{
    PCB pcb = malloc(sizeof(struct PCBStruct));
...
void lines_space(int counter, char *lines[])
{
    if (counter < 3)
    {
